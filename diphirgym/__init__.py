...
register(
	...
	entry_point='diphirgym.envs.inverted_pendulum:InvertedPendulumDIPhiREnv',
...
register(
	...
	entry_point='diphirgym.envs.inverted_double_pendulum:InvertedDoublePendulumDIPhiREnv',
	max_episode_steps=1000,
